...
def Gen_title_combo_row(txt,items,return_all_controls=True):
    # layH: title [combo]
...
def gen_title_combo_button(txt='txt',items=[1,2,3],button_text='bt',
                           button_width=50,
                           return_all_controls=True):
    ...
    if return_all_controls:
        return layH,title,combo,button
    else: return layH
...
class TabBlock(TabPage):
    def __init__(self):
        super(TabBlock,self).__init__()
        self.Text='blk'
        self.ui = AttrDict()
        self.init_ui()
    ...
    def init_ui(self):
        ...
        self.ui.bt_interact=bt_interact
        ...
        morpher,tempTitle,combo_morph,bt_morph=gen_title_combo_button('Morph',['shape1','shape2','shape3'],'Attr')
        ...
        layV.Items.Add(morpher)
        layV.Items.Add(row_typeIndex)
        layV.Items.Add(row_typeIndex2)
        layV.Items.Add(row_top_typeIndex)

        self.ui.lb_selected_block=lb_selected_block
        self.ui.morpher=combo_morph
        self.ui.combo_typeIndex1=combo1
        self.ui.combo_typeIndex2=combo1b
        self.ui.combo_typeTopIndex=comboTop
...
class MainForm(Form):
    ...
    def initUI(self,engine):
        ...
        self.page_GENBLOCK=TabBlock()
        self.UI_GENBLOCK=self.page_GENBLOCK.ui
    ...
    def gen_TOOLBAR(self,layout):
        #this is the tool bar on the side of the panel
        layV=StackLayout(Spacing = 2, Orientation = Orientation.Vertical)
        bt_width=30
        bt_delete=Button()
        bt_delete.Text='del'
